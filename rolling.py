...
def nn_seq_mo(seq_len, B, num,predict_index,removed_factors = None):
    ...
    columns = train_valid.columns.tolist()
    '''
    for time_fea in ['month_sin','month_cos','year_continuous']:
        if time_fea in columns:
            columns.remove(time_fea)
    '''
