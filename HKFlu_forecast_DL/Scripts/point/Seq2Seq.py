...
from Model.Seq2SeqModel import Seq2SeqDataset, Seq2SeqModel, Seq2SeqWeightedTrain, Seq2SeqTrain
...
model_name = f'Seq2Seq_v3_nontuning_rolling_v2_{predict_index}_{data_folder.split("/")[1]}'
############################################### modeling ##########################################
...
def one_bootstrap(i, df, test_size, total_pred_horizon = 5):
    ...
    data_deal1 = Seq2SeqDataset(sequence_length=seq_length1,
    ...
    model1 = Seq2SeqModel(input_dim, output_dim, sequence_dim=seq_length1,
                  mid_dim=mid_dim1, hidden_lstm_layers=hidden_layers1, num_directions = 1)
    model_train1 = Seq2SeqTrain(model1)
    ...
    output_dim = pred_stamp
    data_deal4 = Seq2SeqDataset(sequence_length=seq_length2,
    ...
    model4 = Seq2SeqModel(input_dim, output_dim, sequence_dim=seq_length2,
                    mid_dim=mid_dim2, hidden_lstm_layers=hidden_layers2, num_directions = 1)
    model_train4 = Seq2SeqTrain(model4)
