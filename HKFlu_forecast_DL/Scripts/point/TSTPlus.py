...
model_name = f'TSTPlus_v3_nontuning_rolling_v2_{predict_index}_{data_folder.split("/")[1]}'
...
batch_size1 = trial.params['batch_size']
n_head1 = trial.params['n_heads']
d_model1 =trial.params['d_model']
depth1 = trial.params['n_layers']
dropout_rate1= trial.params['dropout']
att_dropout1 =trial.params['attn_dropout']
learning_rate1 = trial.params['learning_rate']

batch_size2 = trial.params['batch_size']
n_head2 = trial.params['n_heads']
d_model2 =trial.params['d_model']
depth2 = trial.params['n_layers']
dropout_rate2= trial.params['dropout']
att_dropout2 =trial.params['attn_dropout']
learning_rate2 = trial.params['learning_rate']
...
def one_bootstrap(i, df, test_size, total_pred_horizon):
    ...
    fcst1 = TSForecaster(x_train1, y_train1, splits=splits1, bs=batch_size1, arch="TSTPlus",
                         arch_config={'n_heads':n_head1, 'd_model':d_model1, 'n_layers':depth1,"dropout":dropout_rate1,"attn_dropout":att_dropout1},
    ...
    print(x_test2.shape, y_test2.shape)
    fcst2 = TSForecaster(x_train2, y_train2, splits=splits2, bs=batch_size2, arch="TSTPlus",
                         arch_config={'n_heads':n_head2, 'd_model':d_model2, 'n_layers':depth2,"dropout":dropout_rate2,"attn_dropout":att_dropout2},
                         metrics=mse, train_metrics=True, seed=i, verbose=False)
