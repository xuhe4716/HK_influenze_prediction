...
from Model.LstmFcnModel import LstmDataset, LstmModel, LstmWeightedTrain, LstmTrain
...
model_name = f'LSTMFcn_v3_nontuning_rolling_v2_{predict_index}_{data_folder.split("/")[1]}'
############################################### modeling ##########################################
